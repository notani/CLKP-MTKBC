...
"""Calculate meanrank for all method on all split.

Example:
    nice -n 19 python scripts/twa/eval/meanrank_wrapper.py /baobab/otani/cckbc/cn/20170814v1/ens/kbc-170816v2/split -v --by-relation
"""
...
verbose = False
logger = init_logger('EvalMeanrank')
...
def main(args):
    ...
    for d in os.listdir(args.dir_split):
        ...
        for method in methods:
            ...
            args.method = method
            results[method].append(meanrank.main(args))
